...
Телеграм-бот для автоматизованої підготовки до технічних співбесід для IT-спеціалістів. Бот пропонує тестування з різних напрямків (Python, Java, QA), збирає статистику правильних відповідей та допомагає виявити прогалини у знаннях.
