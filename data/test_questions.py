...
QUESTIONS = [
    ...
    Question(
        ...
        options=[
            "Тільки компілюється",
            (
                "Інтерпретується (байт-код виконується "
                "віртуальною машиною)"
            ),
    ...
    Question(
        ...
        options=[
            (
                "`==` порівнює значення, а `is` порівнює "
                "посилання на об'єкти в пам'яті"
            ),
    ...
    Question(
        ...
        options=[
            ...
            (
                "Коли клас успадковує властивості та методи від "
                "двох і більше батьківських класів"
            ),
    ...
    Question(
        text=(
            "Як називається короткий синтаксис для створення "
            "нових списків на основі існуючих?"
        ),
        category="Python",
    ...
    Question(
        ...
        options=[
            ...
            (
                "Метод-конструктор, який ініціалізує атрибути "
    ...
    Question(
        text=(
            "У чому перевага конструкції `try-with-resources` "
            "перед звичайним `try-catch`?"
        ),
        category="Java",
        options=[
            "Вона працює швидше",
            (
                "Вона автоматично закриває ресурси (наприклад, файли), "
    ...
    Question(
        ...
        options=[
            ...
            (
                "Коли JVM не може виділити більше пам'яті для "
    ...
    Question(
        ...
        options=[
            ...
            (
                "Популярний фреймворк для реалізації ORM "
    ...
    Question(
        text=(
            "Яке ключове слово використовується, щоб заборонити зміну "
            "значення змінної після ініціалізації?"
        ),
        category="Java",
    ...
    Question(
        ...
        options=[
            (
                "ArrayList повільніший при читанні, але швидший "
                "при вставці в середину"
            ),
            (
                "ArrayList використовує динамічний масив, а LinkedList — "
    ...
    Question(
        text=(
            "Який метод є стандартною точкою входу в будь-яку "
            "самостійну Java програму?"
        ),
        category="Java",
        options=[
            "public void start()",
    ...
    Question(
        ...
        options=[
            ...
            (
                "Чи не зламався існуючий функціонал після додавання "
                "нового коду або виправлення багів"
            ),
    ...
    Question(
        ...
        options=[
            "Це синоніми",
            (
                "Severity вказує, наскільки швидко треба виправити баг, "
                "а Priority — який модуль він зачіпає"
            ),
            (
                "Priority визначає черговість (бізнес-вимога), а Severity "
                "вказує на ступінь технічного впливу"
            ),
            (
                "Priority використовується тільки розробниками, "
                "а Severity — тестувальниками"
            ),
        ],
        correct_option=2,
    ),
    Question(
        ...
        options=[
            ...
            (
                "Тестування поведінки програми на межах діапазонів класів "
                "еквівалентності (наприклад, 0, 1, 10, 11)"
            ),
    ...
    Question(
        ...
        category="QA",
        options=[
            "Тестування системи до тих пір, поки вона не 'задимиться'",
            (
                "Поверхнева перевірка критичного функціоналу для визначення, "
                "чи має сенс проводити глибше тестування"
            ),
    ...
    Question(
        text=(
            "Яке з цих полів є обов'язковим та найважливішим "
            "у якісному баг-репорті?"
        ),
        category="QA",
        options=[
    ...
    Question(
        ...
        options=[
            ...
            (
                "Документ з набором кроків, тестових даних та очікуваних "
                "результатів для перевірки певної функції"
            ),
